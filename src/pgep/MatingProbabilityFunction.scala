...
object DirectFitnessToProbability extends MatingProbabilityFunction {
  protected override def calculateMatingProbability(min: Double, max: Double, median: Double, fitness: Double) = min + max - fitness
}

object ParabolicMappingFitnessToProbability extends MatingProbabilityFunction {
...
object EllipticMappingFitnessToProbability extends MatingProbabilityFunction {
  protected override def calculateMatingProbability(min: Double, max: Double, median: Double, fitness: Double) =
    if (min == max) 1
...
object SemiEllipticSemiParabolic extends MatingProbabilityFunction {
  protected override def calculateMatingProbability(min: Double, max: Double, median: Double, fitness: Double) =
	if (min == max) 1
